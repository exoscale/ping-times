...
(def default-db
  {:ping       {:ch-zrh-1  {:latency 0 :initial? false}
                :de-fra-1 {:latency 0 :initial? false}
                :ch-gva-2 {:latency 0 :initial? false}
                :at-vie-1 {:latency 0 :initial? false}}
   :endpoints  {:ch-zrh-1  "https://ping-times.sos-ch-dk-2.exo.io/index.html" ;; FIXME, once host is up
   ...
   :detail-zone nil
   :details    {:ch-zrh-1 {:title "Zurich Datacenter"
                          :content "Designed for scale, CH-ZRH-1 is the latest datacenter from Equinix in Switzerland, built with state-of-the-art technologies, it is also home to Switzerland's densest network exchange point."
                          :img "dc-ch-zh-1.png"}
